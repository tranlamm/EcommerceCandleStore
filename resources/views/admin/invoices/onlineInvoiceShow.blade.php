...
<div class="page-wrapper">
    ...
    <div class="page__content-wrapper">
        <div class="row mb-3">
            <div class="col col-xl-8 col-12 mt-3">
                <form class="row gx-2" id="form__search" method="GET" action="{{ route('onlineinvoice.index') }}">
                    <div class="col col-6">
            ...
            <div class="col col-xl-4 col-12 mt-3">
                <div class="d-flex">
    ...
    <div class="page__content-wrapper">
        ...
        <div class="d-flex justify-content-center mt-4">
            {{ $onlineInvoices->appends($data)->onEachSide(1)->links('pagination::bootstrap-4') }}
        </div>
    </div>
</div>
