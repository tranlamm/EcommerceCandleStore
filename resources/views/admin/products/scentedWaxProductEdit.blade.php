...
<div class="page-wrapper">
    ...
    <div class="page__content-wrapper">
        ...
        <form action="/admin/scentedwaxproduct/{{ $scentedWaxProduct->id }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PATCH')
            <div class="form-floating mb-4">
                <input type="text" class="form-control" id="input1" placeholder="name@example.com" name="tenSanPham" value="{{ $scentedWaxProduct->tenSanPham }}"> 
            ...
            <div class="row mb-3">
                <div class="col col-8">
                    ...
                    <select class="form-select" aria-label="Default select example" name="nhaCungCap">
                        @foreach ($manufacturers as $manufacturer)
                            <option value="{{ $manufacturer->id }}" {{ ($scentedWaxProduct->nhaCungCap === $manufacturer->id) ? "selected" : "" }}>{{ $manufacturer->ten }}</option>
                        @endforeach
                    </select>
                ...
                <div class="col col-4">
                    <div class="form-floating mt-2">
                        <input type="text" class="form-control" id="input4" placeholder="name@example.com" name="trongLuong" value="{{ $scentedWaxProduct->trongLuong }}">
            ...
            <div class="row mb-3">
                <div class="col col-12">
                    ...
                    <input type="hidden" name="old_image" value="{{ $scentedWaxProduct->image_path }}">
                    @if ($errors->has('image'))
            ...
            <div class="mb-4">
                ...
                <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="moTa">{{ $scentedWaxProduct->moTa }}</textarea>
            </div>
            
            <div class="row">
                <div class="col col-6">
                    <div class="form-floating mb-4">
                        <input type="text" class="form-control" id="input6" placeholder="name@example.com" name="giaNhap" value="{{ $scentedWaxProduct->giaNhap }}"> 
                ...
                <div class="col col-6">
                    <div class="form-floating mb-4">
                        <input type="text" class="form-control" id="input7" placeholder="name@example.com" name="giaBan" value="{{ $scentedWaxProduct->giaBan }}">
