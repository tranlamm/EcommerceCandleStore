            ...
            <div class="row mb-3">
                ...
                <div class="col col-4">
                    <div class="form-floating mt-2">
                        <input type="text" class="form-control" id="input4" placeholder="name@example.com" name="theTich" value="{{ old('theTich') }}">
                        <label for="input4" class="form-label"><strong>Thể tích *</strong></label>
                        @if ($errors->has('theTich'))
                            <span class="text-danger mt-2">{{ $errors->first('theTich') }}</span>
                        @endif
                    </div> 
                </div>
            </div>
