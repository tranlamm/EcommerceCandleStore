...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        'resources/sass/customer/customer.scss', 'resources/sass/login/login_customer.scss', 'resources/sass/customer/account.scss',
        'resources/sass/customer/invoice.scss',])
